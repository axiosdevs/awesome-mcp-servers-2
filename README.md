...
- <img src="https://agents-coin.com/favicon.ico" height="14"/> [AgentsCoin](https://github.com/axiosdevs/agentscoin-mcp) - Give your AI agent its own money — create a wallet, get AGENT from the faucet, send, and create/trade tokens on a live EVM chain
